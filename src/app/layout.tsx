              ...
              <Link href="/" className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Troc de talents et services a Lome
                  </p>
                </div>
              </Link>
              ...
              <nav className="hidden items-center gap-3 md:flex">
                {[
                  ...
                  <Link
                    key={href}
                    href={href}
                    className="pill-link rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200 hover:border-cyan-400/60 hover:bg-cyan-400/10"
                  >
                    {label}
                  </Link>
                ))}
